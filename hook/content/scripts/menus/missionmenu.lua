...
local pickupengine = function()
	if Network:is_server() then else 
		managers.chat:_receive_message(1, "PickupEngine", "Host only!", tweak_data.system_chat_color)
		return
	end
...
local function disable_lasers()
	if Network:is_server() then else 
		managers.chat:_receive_message(1, "Lasers", "Host only!", tweak_data.system_chat_color)
		return
	end
...
mission_table = {
	...
	{},
	{ text = "Start/Stop Assault - ON/OFF", callback_func = function() dofile("mods/hook/content/scripts/assault.lua") end },
	...
	["nmh"] = {
	{ text = "Circuit Breaker - ON", callback_func = function() interactbytweak('circuit_breaker') end },
	...
	["pex"] = {
	{ text = "Interact Objective - ON", callback_func = function() interactbytweak('pex_find_a_tag','pex_medal','lockpick_locker','open_from_inside','pickup_evidence_pex','hold_turn_off_sprinklers','pex_flammable_liquid','pex_armory_hack','pex_door_hydraulic_opener','pex_pickup_cutter','pex_cut_open_chains','pex_destroy_evidence_directional_shredder','pickup_police_uniform','pex_hook_car') end },
	},
	["bex"] = {
	...
	["fex"] = {
	{ text = "Turtle Symbol - ON", callback_func = function() interactbytweak('fex_press_turtle_symbol') end },
	{ text = "Squirrel Symbol - ON", callback_func = function() interactbytweak('fex_press_squirrel_symbol') end },
	{ text = "Spider Symbol - ON", callback_func = function() interactbytweak('fex_press_spider_symbol') end },
	{ text = "Snake Symbol - ON", callback_func = function() interactbytweak('fex_press_snake_symbol') end },
	{ text = "Snail Symbol - ON", callback_func = function() interactbytweak('fex_press_snail_symbol') end },
	{ text = "Owl Symbol - ON", callback_func = function() interactbytweak('fex_press_owl_symbol') end },
	{ text = "Monkey Symbol - ON", callback_func = function() interactbytweak('fex_press_monkey_symbol') end },
	{ text = "Millipede Symbol - ON", callback_func = function() interactbytweak('fex_press_millipede_symbol') end },
	{ text = "Lizard Symbol - ON", callback_func = function() interactbytweak('fex_press_lizard_symbol') end },
	{ text = "Jaguar Symbol - ON", callback_func = function() interactbytweak('fex_press_jaguar_symbol') end },
	{ text = "Frog Symbol - ON", callback_func = function() interactbytweak('fex_press_frog_symbol') end },
	{ text = "Fish Symbol - ON", callback_func = function() interactbytweak('fex_press_fish_symbol') end },
	{ text = "Dog Symbol - ON", callback_func = function() interactbytweak('fex_press_dog_symbol') end },
	{ text = "Crocodile Symbol - ON", callback_func = function() interactbytweak('fex_press_crocodile_symbol') end },
	{ text = "Crab Symbol - ON", callback_func = function() interactbytweak('fex_press_crab_symbol') end },
	{ text = "Butterfly Symbol - ON", callback_func = function() interactbytweak('fex_press_butterfly_symbol') end },
	{ text = "Bunny Symbol - ON", callback_func = function() interactbytweak('fex_press_bunny_symbol') end },
	{ text = "Boar Symbol - ON", callback_func = function() interactbytweak('fex_press_boar_symbol') end },
	{ text = "Bat Symbol - ON", callback_func = function() interactbytweak('fex_press_bat_symbol') end },
	{ text = "Ant Symbol - ON", callback_func = function() interactbytweak('fex_press_ant_symbol') end },
	{ text = "Take Fertilizer - ON", callback_func = function() interactbytweak('fex_take_fertilizer') end },
	{ text = "Take Scythe - ON", callback_func = function() interactbytweak('fex_take_scythe') end },
	{ text = "Take Churros - ON", callback_func = function() interactbytweak('fex_take_churros') end },
	{ text = "Take Blowtorch - ON", callback_func = function() interactbytweak('gen_pku_blow_torch') end },
	{ text = "Take Globe - ON", callback_func = function() interactbytweak('fex_take_globe') end },
	{ text = "Take Alarm - ON", callback_func = function() interactbytweak('fex_take_alarm_clock') end },
	{ text = "Take Wire - ON", callback_func = function() interactbytweak('fex_take_wire_axis') end },
	{ text = "Take Diesel - ON", callback_func = function() interactbytweak('fex_take_diesel') end },
	{ text = "Take Saw - ON", callback_func = function() interactbytweak('gen_pku_saw_axis') end },
	{ text = "Search Bookcase - ON", callback_func = function() interactbytweak('hold_interact_inspect_bookshelf') end },
	{ text = "Interact Objective - ON", callback_func = function() interactbytweak('') end },
	},
	["mex"] = {
...
function mission_menu()
	...
	if SystemFS:exists("mods/TheCooker/mod.txt") then
		if (list[2] == 'mex_cooking') or (list[2] == 'mia_1') or (list[2] == 'cane') or (list[2] == 'nail') or (list[2] == 'rat') or (list[2] == 'alex_1') then
			managers.mission._fading_debug_output:script().log("Autocooker not compatible with 'The Cooker' mod", Color.red)
			for _, mission_func in pairs(mission_table["absolute"]) do
